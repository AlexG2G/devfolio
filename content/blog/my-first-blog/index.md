...
##  Built with Python 
This was a program designed in my first semester at the University of Canberra. This project was meant to show us how the programming language Python, and how programs in general can help solve real world problems and have real world applications that automate a problem and display an interface for the user.
